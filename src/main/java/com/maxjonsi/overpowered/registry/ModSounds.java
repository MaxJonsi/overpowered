...
public class ModSounds {
    ...
    public static final SoundEvent YAMATO_RIFT = register("yamato.rift");
    public static final SoundEvent YAMATO_SKY_BREAK = register("yamato.sky_break");
    public static final SoundEvent YAMATO_FINAL_MUSIC = register("yamato.final_music");
    ...
    public static final SoundEvent LAUNCHER_NUKE_FALL = register("launcher.nuke_fall");
    ...
    public static final SoundEvent GOJO_DOMAIN_INTERIOR = register("gojo.domain_interior");
    public static final SoundEvent VOID_KILL = register("void.kill");
    public static final SoundEvent VOID_FORM_AMBIENCE = register("void.form_ambience");
    public static final SoundEvent VOID_ABSOLUTE_AMBIENCE = register("void.absolute_ambience");
    public static final SoundEvent VOID_ABSOLUTE_RELEASE = register("void.absolute_release");
